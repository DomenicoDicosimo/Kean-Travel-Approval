        ...
        <VStack spacing={4} align="stretch">
          ...
          {isLoading ? (
            ...
            <form onSubmit={addUserToDatabase}>
              <FormControl>
                  <FormLabel>Please enter this additional information if you just created your account.</FormLabel>
              </FormControl>
              ...
              <FormControl id="sex">
                ...
                <Select placeholder="Select sex" value={sex} onChange={e => setSex(e.target.value)}>
