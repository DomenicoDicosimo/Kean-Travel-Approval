...
import { Box, Input, FormControl, FormLabel, Button, Flex, Stack, HStack } from '@chakra-ui/react';
...
export default function TravelAuthorizationRequestForm() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    const response = await fetch('http://127.0.0.1:5000/submit-travel-authorization-request-form', {
      method: 'POST',
      headers: {
