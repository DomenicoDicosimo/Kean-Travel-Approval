...
import {
    Box, Card, Grid, GridItem, Heading, Stack, Text, VStack, HStack, Tag,
    useDisclosure, Modal, ModalOverlay, ModalContent, Alert, AlertIcon, AlertTitle, ModalHeader, ModalCloseButton, ModalBody
  ...
  return (
    <>
        ...
        <Modal isOpen={isOpen} onClose={onClose} size="full">
                <ModalOverlay />
                <ModalContent maxW="80vw" maxH="80vh" overflow="auto"> {/* Custom size */}
